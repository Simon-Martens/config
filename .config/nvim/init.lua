...
require('lazy').setup {
  ...
  -- Leap
  -- Leap is a plugin that allows you to quickly jump to any line in the current buffer
  -- by typing a few characters from that line.
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      -- Animations can make vertical navigation easier
      -- require('mini.animate').setup() {}

      -- F/f/t/T can work over multiple lines
  ...
  --
  -- Plugin for a diagnosics window
  {
    'folke/trouble.nvim',
